...
export function createSite(
  data: CreateSiteData,
): Promise<{ site: Site; token: string }> {
...
export function createToken(
  ...
  return request.post(`/sites/${siteId}/tokens`, data) as Promise<{
    token: SiteToken;
  }>;
}
...
export function deleteToken(
  ...
  return request.delete(`/sites/${siteId}/tokens/${tokenId}`) as Promise<{
    success: boolean;
  }>;
}
