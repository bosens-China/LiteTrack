...
export function getPopularPages(
  siteId: number,
): Promise<{ popularPages: PageView[] }> {
  return request.get(`/stats/${siteId}/popular`) as Promise<{
    popularPages: PageView[];
  }>;
}
...
export function getTrend(
  siteId: number,
  days?: number,
): Promise<{ dailyViews: DailyView[] }> {
  return request.get(`/stats/${siteId}/trend`, {
    params: { days },
  }) as Promise<{ dailyViews: DailyView[] }>;
}
...
export function getSitePages(
  ...
  return request.get(`/stats/${siteId}/pages`, {
    params: query,
...
export function getVisitorsStats(
  ...
  return request.get(`/stats/${siteId}/visitors`, {
    params: query,
  }) as Promise<VisitorsStatsResponse>;
}
...
export function getDeviceStats(
  ...
  return request.get(`/stats/${siteId}/devices`, {
    params: query,
  }) as Promise<DevicesStatsResponse>;
}
...
export function getReadingStats(
  ...
  return request.get(`/stats/${siteId}/reading`, {
    params: query,
  }) as Promise<ReadingStatsResponse>;
}
...
export interface ReferrersStatsResponse {
  summary: { days: number };
...
export interface DurationPageItem {
  path: string;
  avgDuration: number;
  sampleCount: number;
}
...
export interface DurationStatsResponse {
  summary: { days: number; path: string | null };
  pages: DurationPageItem[];
}

export function getReferrersStats(
  siteId: number,
  query?: AnalyticsDaysQuery,
): Promise<ReferrersStatsResponse> {
  return request.get(`/stats/${siteId}/referrers`, {
    params: query,
  }) as Promise<ReferrersStatsResponse>;
}

export function getBounceStats(
  siteId: number,
  query?: AnalyticsDaysQuery,
): Promise<BounceStatsResponse> {
  return request.get(`/stats/${siteId}/bounce`, {
    params: query,
  }) as Promise<BounceStatsResponse>;
}
...
export function getDurationStats(
  ...
  return request.get(`/stats/${siteId}/duration`, {
    params: query,
  }) as Promise<DurationStatsResponse>;
}
...
export function getAccessLogs(
  ...
  return request.get(`/stats/${siteId}/logs`, {
    params: query,
  }) as Promise<AccessLogsResponse>;
}
